    ...
    const cargarDashboard = async () => {
      try {
        ...
        const masVendidos = productos
          ...
          .sort((a, b) => {
            // Ordenar por productos con menos stock (como proxy de más vendidos)
          ...
          .map(p => ({
            ...p,
            totalVendidos: Math.floor(Math.random() * 50) + 10 // Datos simulados por ahora
          }));
  ...
  return (
    <div className="dashboard-container">
      <header className="dashboard-header mb-4">
        ...
        <p className="text-muted">Resumen general del sistema HazelLab</p>
            ...
            <div className="system-status">
              ...
              <div className="status-item">
                ...
                <span className="status-text">
                  {estadisticas.totalProductos > 0 ? '✅ Con datos' : '⚠️ Vacío'}
                </span>
              </div>
            </div>
          </div>
