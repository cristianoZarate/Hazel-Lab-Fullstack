  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response?.status === 400) {
        ...
        alert("⚠️ No se pudo crear el usuario. Revisa los datos e intenta nuevamente.");
      }
    } finally {
      setCreando(false);
    }
        ...
        <div className="row g-3 mt-4">
          ...
          <div className="col-md-6">
            ...
            >
              ...
              <option value="administrador">🛡️ Administrador (Acceso completo excepto eliminar)</option>
            ...
            <div className="card border-info">
              <div className="card-header bg-info bg-opacity-10 d-flex justify-content-between align-items-center">
                ...
                <span className={`badge ${Object.keys(errores).length === 0 ? 'bg-success' : 'bg-warning'}`}>
                  {Object.keys(errores).length === 0 ? '✅ Válido' : '⚠️ Revisar errores'}
                </span>
              </div>
